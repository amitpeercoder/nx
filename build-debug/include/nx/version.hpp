...
struct GitVersionInfo {
    ...
    static constexpr std::string_view full = "1.0.0-debug.6a5404f+dirty";
    static constexpr std::string_view commit_hash = "6a5404f";
    ...
    static constexpr std::string_view commits_since_tag = "31";
