...
struct GitVersionInfo {
    ...
    static constexpr std::string_view full = "0.1.0-debug.00f47d5+dirty";
    static constexpr std::string_view commit_hash = "00f47d5";
    ...
    static constexpr std::string_view commits_since_tag = "7";
